...
class PathologistController extends Controller
{
    public function index()
    {
        ...
        return view('admin.pathologist.index',compact('pathologists'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.pathologists')->with('success', 'Pathologist created successfully.'); 
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.pathologists')->with('success', 'Pathologist Update successfully.'); 
    }

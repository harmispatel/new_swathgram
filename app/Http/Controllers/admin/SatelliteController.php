...
class SatelliteController extends Controller
{
    ...
    public function index()
    {
        ...
        $organizations = $devices->pluck('organizations')
                        ->unique('id')
                        ->values();
        return view('admin.satellite_data.index', compact('organizations'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.satellite_data.show',compact('devices','organization'));
    }
    ...
    {
        return view('admin.satellite_data.test_map');
    }
}

...
class LabTechnicianController extends Controller
{
    public function index()
    {
        ...
        return view('admin.lab_technician.index',compact('lab_technicians'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.lab_technician')->with('success', 'Lab Technician created successfully.'); 
    }
    ...
    public function update(Request $request)
    {
       ...
       $updateData = [
        ...
        return redirect()->route('admin.lab_technician')->with('success', 'Lab Technician Update successfully.'); 
    }

...
class CampController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('lab_technician.camp.create',compact('organizations','pathologists','lab_technicians','packages'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('lab_technician.camp')->with('success', 'Camp created successfully.'); 
    }
    ...
    public function edit($id)
    {
        ...
        return view('lab_technician.camp.edit',compact('camp','pathologists','organizations','lab_technicians','packages','devices'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('lab_technician.camp')->with('success', 'Camp Update successfully.');
    }

...
class PathologistController extends Controller
{
    public function index()
    {
        ...
        return view('manager.pathologist.index',compact('pathologists'));
    }

    public function create()
    {
        $organizations = Organization::orderBy('id','desc')->get();
        return view('manager.pathologist.create',compact('organizations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.pathologists')->with('success', 'Pathologist created successfully.'); 
    }
    ...
    public function edit($id)
    {
        ...
        return view('manager.pathologist.edit',compact('pathologist','organizations'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('manager.pathologists')->with('success', 'Pathologist Update successfully.'); 
    }

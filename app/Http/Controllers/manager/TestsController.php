...
class TestsController extends Controller
{
    public function index()
    {
        ...
        return view('manager.tests.index',compact('tests'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.test')->with('success', 'Test created successfully.'); 
    }
    ...
    public function edit($id)
    {
        ...
        $profiles = TestProfile::with('department')->orderBy('id','desc')->get();
        $sub_profiles = TestSubprofile::with('department','profile')->orderBy('id','desc')->get();
        return view('manager.tests.edit',compact('test','departments','profiles','sub_profiles'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('manager.test')->with('success', 'Test Update successfully.'); 
    }

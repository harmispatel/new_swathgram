...
class CampController extends Controller
{
    public function index()
    {
        ...
        return view('pathologist.camp.index',compact('camps'));
    }
    ...
    {  
        ...
        return view('pathologist.camp.create',compact('organizations','pathologists','lab_technicians','packages'));
    }
    ...
    public function store(Request $request)
    {
            ...
            return redirect()->route('pathologist.camp')->with('success', 'Camp created successfully.'); 
    ...
    public function edit($id)
    {
        ...
        return view('pathologist.camp.edit',compact('camp','pathologists','organizations','lab_technicians','packages','devices'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('pathologist.camp')->with('success', 'Camp Update successfully.');

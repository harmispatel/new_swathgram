...
class TestsController extends Controller
{
    public function index()
    {
        ...
        return view('pathologist.tests.index',compact('tests'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pathologist.tests.edit',compact('test','departments','profiles','sub_profiles'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('pathologist.test')->with('success', 'Test Update successfully.'); 
    }

                ...
                <div class="row">
                    ...
                    <div class="col-md-9 d-flex">
                        <div class="form-check form-switch">
                            ...
                            <input name="signature_1_status" id="signature_1_status" class="form-check-input m-0" type="checkbox" role="switch" value="1" checked>
                        </div>

                        <div class="signature-image ms-3">
                            <input type="hidden" name="signature_1" id="signature_1" value="" class="form-control {{ $errors->has('signature_1') ? 'is-invalid' : '' }}">
                            <img id="signature_1_image" src="" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 d-flex">
                        <div class="form-check form-switch">
                            ...
                            <input name="signature_2_status" class="form-check-input m-0" type="checkbox" role="switch" id="signature_2_status" value="1" checked>
                        </div>

                        <div class="signature-image ms-3">
                            <input type="hidden" name="signature_2" id="signature_2" class="form-control {{ $errors->has('signature_2') ? 'is-invalid' : '' }}">
                            <img id="signature_2_image" src="" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 d-flex">
                        <div class="form-check form-switch">
                            ...
                            <input name="signature_3_status" class="form-check-input m-0" type="checkbox" role="switch" id="signature_3_status" value="1" checked>
                        </div>

                        <div class="signature-image ms-3">
                            <input type="hidden" name="signature_3" class="form-control {{ $errors->has('signature_3') ? 'is-invalid' : '' }}">
                            <img id="signature_3_image" src="" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 d-flex">
                        <div class="form-check form-switch">
                            ...
                            <input name="signature_4_status" id="signature_4_status" class="form-check-input m-0" type="checkbox" role="switch" id="signature_4_status" value="1" checked>
                        </div>

                        <div class="signature-image ms-3">
                            <input type="hidden" name="signature_4" id="signature_4" class="form-control {{ $errors->has('signature_4') ? 'is-invalid' : '' }}">
                            <img id="signature_4_image" src="" alt="" style="height: 100px;">

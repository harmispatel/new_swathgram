...
<section class="section show-section pathologist mt-3">
    <div class="addbutton">
        <a href="{{ route('pathologist.create') }}" class="btn btn-primary">Add Pathologist</a>
    </div>  
    <div class="row">
            ...
            <tbody>
                @foreach ($pathologists as $pathologist)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('pathologist.edit', encrypt($pathologist->id)) }}"><i class="bi bi-pencil-square"></i></a>

...
<section class="section store-form manager mt-3">
    <form action="{{ route('manager.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="date" name="dob" class="form-control {{ $errors->has('dob') ? 'is-invalid' : '' }}" max="{{ $today }}" value="{{old('dob')}}">
                        @if($errors->has('dob'))
                            <div class="invalid-feedback">
                                {{ $errors->first('dob') }}
                            </div>
        ...
        <div class="text-center mb-3 mt-5">
            <a href="{{ route('managers') }}" type="button" class="btn btn-danger me-2">Cancel</a>

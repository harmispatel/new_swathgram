                        ...
                        <div class="login_detail_left">
                            <div class="card mb-3">
                                ...
                                <div class="card-body login-bg">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-white pb-0 fs-4">Forgot Password</h5>
                                        <p class="small text-white">Enter your details</p>
                                    </div>

                                    <form class="row g-3" method="POST"
                                        action="{{ route('do.forgot.password') }}">
                                        @csrf
                                        ...
                                        <div class="col-12">
                                            <div class="input-group">
                                                <input type="password" name="old_password" placeholder="Old Password"
                                                    ...
                                                    id="old_password" style="color: white;">
                                        ...
                                        <div class="col-12">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-text" style="cursor: pointer;background-color: #1f2024;border: none;color: #77777A;border-bottom: 2px solid #77777A;border-radius: 0px;"
                                                    onclick="ShowHidePassword()" id="passIcon">
                                                    <i class="bi bi-eye-slash"></i>
                                                </span>

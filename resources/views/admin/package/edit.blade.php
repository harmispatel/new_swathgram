...
<section class="section store-form package mt-3">
    <form action="{{ route('admin.package.update') }}" id="package-form" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="text-center mb-3 mt-5">
            <a href="{{ route('admin.package') }}" type="button" class="btn btn-danger me-2">Cancel</a>
...
<script>
    ...
    $('#profile').on('change', function () {
        ...
        if (profileId) {
            $.ajax({
                    type: "POST",
                    url: '{{ route("admin.tests.profiles") }}',
                    data: {
                        "_token": "{{ csrf_token() }}",

...
<section class="section show-section camp mt-3">
    <div class="addbutton">
        <a href="{{ route('manager.camp.create') }}" class="btn btn-primary">Add Camp</a>
    </div>  
    <div class="row">
            ...
            <tbody>
                @foreach ($camps as $camp)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('manager.camp.edit', encrypt($camp->id)) }}"><i class="bi bi-pencil-square"></i></a>

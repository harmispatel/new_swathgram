...
<section class="section show-section package mt-3">
    <div class="addbutton">
        <a href="{{ route('manager.package.create') }}" class="btn btn-primary">Add Package</a>
    </div>  
    <div class="row">
            ...
            <tbody>
                @foreach ($packages as $package)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('manager.package.edit', encrypt($package->id)) }}"><i class="bi bi-pencil-square"></i></a>
    ...
    function deletePackage(packageId)
    {
        ...
        .then((willDelClient) =>
        {
            if (willDelClient)
            {
                $.ajax({
                    type: "POST",
                    url: '{{ route("manager.package.delete") }}',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        'id': packageId,
                    },

...
<section class="section show-section lab_technician mt-3">
    <div class="addbutton mb-5">
        {{-- <a href="{{ route('manager.test.create') }}" class="btn btn-primary">Add Test</a>
            ...
            <tbody>
                ...
                @foreach ($tests as $test)
                    <tr>
                        ...
                        <td>{{ $test->price }}</td>
                        <td>
                            <a href="{{ route('manager.test.edit', encrypt($test->id)) }}"><i class="bi bi-pencil-square"></i></a>

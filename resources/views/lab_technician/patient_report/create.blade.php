        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="profile" class="form-control {{ $errors->has('profile') ? 'is-invalid' : '' }}" placeholder="profile">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <select name="test[]" id="test" class="form-control {{ $errors->has('test') ? 'is-invalid' : '' }}" multiple>
